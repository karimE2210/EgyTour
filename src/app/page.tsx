    ...
    <main>
      ...
      <section className="py-8 bg-gray-50 dark:bg-gray-900">
        <div className="container-custom text-center">
          <h2 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">{t("home.interactiveMap.title")}</h2>
          <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">{t("home.interactiveMap.subtitle")}</p>
          ...
          <p className="mt-6 text-sm text-gray-500 dark:text-gray-400">{t("home.interactiveMap.clickInstructions")}</p>
        </div>
      </section>
      ...
      <section className="py-20 bg-white dark:bg-gray-950">
        <div className="container-custom text-center">
          <h2 className="text-3xl font-bold mb-6 text-gray-900 dark:text-white">{t("home.exploreByMood.title")}</h2>
          <p className="text-gray-600 dark:text-gray-300 mb-10">{t("home.exploreByMood.subtitle")}</p>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-6">
            {[
              { label: t("home.exploreByMood.moods.relax"), icon: "🧘", link: "/things-to-do/wellness-and-relaxation" },
              { label: t("home.exploreByMood.moods.thrill"), icon: "🎢", link: "/things-to-do/adventure-and-theme-parks" },
              { label: t("home.exploreByMood.moods.explore"), icon: "🧭", link: "/things-to-do/desert-and-outdoor-activities" },
              { label: t("home.exploreByMood.moods.historyBuff"), icon: "🏛️", link: "/things-to-do/historical-sites" },
              { label: t("home.exploreByMood.moods.artsy"), icon: "🎨", link: "/art-culture" },
              { label: t("home.exploreByMood.moods.offTheGrid"), icon: "🌍", link: "/where-to-go/oases-and-villages" },
            ].map(({ label, icon, link }) => (
              <Link
                key={label}
                href={link}
              ...
              >
                <span className="text-4xl mb-2 group-hover:scale-125 transition-transform">{icon}</span>
      ...
      <section className="py-20 bg-gradient-to-r from-[#fdf6e3] to-[#fff9f1] dark:from-gray-800 dark:to-gray-900">
        <div className="container-custom text-center">
          <h2 className="text-3xl font-bold mb-6 text-gray-900 dark:text-white">{t("home.hiddenEgypt.title")}</h2>
          <p className="text-gray-600 dark:text-gray-300 mb-10">{t("home.hiddenEgypt.subtitle")}</p>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { name: "El-Minya", img: "/images/mypics/elminya.jpeg", link: "/where-to-go/hidden-egypt" },
              { name: "Dakhla Oasis", img: "/images/mypics/Dakhla Oasis.jpeg", link: "/where-to-go/hidden-egypt" },
              { name: "Tanis", img: "/images/mypics/Tanis.jpeg", link: "/where-to-go/hidden-egypt" },
            ].map(({ name, img, link }) => (
              <Link key={name} href={link} className="relative group overflow-hidden rounded-xl shadow-md block">
                <Image 
                  src={img} 
                  alt={name} 
                  width={300}
          ...
          <Link 
            href="/where-to-go/hidden-egypt" 
            className="inline-block mt-8 px-6 py-3 bg-amber-600 text-white rounded-lg hover:bg-amber-700 transition"
          >
            {t("home.hiddenEgypt.cta")}
          </Link>
        </div>
      </section>
